...
/**
 * shiro-cas单点登陆配置
 * 主要是单点登录、登出的相关配置和跳转地址，把shiro-session拿掉，不然单点登出会有问题。
 */
@Configuration
public class ShiroCasConfiiguration {
    ...
    //当前工程对外访问地址
    public static final String shiroServerUrlPrefix = "http://localhost:8084";
    ...
    public UserShiroCasRealm userRealm() {
        ...
        //userShiroCasRealm.setCredentialsMatcher(hashedCredentialsMatcher()); //设置密码加密
